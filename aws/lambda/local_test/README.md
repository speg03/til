...
This is a sample template for local_test - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name local_test --tail
```
...
```bash
aws cloudformation delete-stack --stack-name local_test
```
